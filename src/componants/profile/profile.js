...
export default class Profile extends React.Component{
  ...
  updateUser(id){
    fetch(`/API/userUpdate/${id}/`, {
      ...
      "body": JSON.stringify({
        userName: document.getElementById("username").value == '' ? document.getElementById("username").defaultValue:
        ...
        document.getElementById("username").defaultValue.split(" ")[0]:
          document.getElementById("username").value.split(" ")[0]
        
        ,
        userLastName: 
        document.getElementById("username").value.split(" ")[1] == '' ? 
        document.getElementById("username").defaultValue.split(" ")[1]:
          document.getElementById("username").value.split(" ")[1]
          ...
          <div className="card_content">
            ...
            <form  className="form_edit">
                <div className="input_line">
                    ...
                    <input className="edit_input" name = "email" type="text"  id="username"
                ...
                <div className="input_line">
                    ...
                    <input id="password" className="edit_input" name = "email" type={this.state.edit ? "text" : "password" }
                    disabled= {this.state.edit ?  "": "disabled"}
              ...
              <div style={{display: "flex", alignItems:"center" }}>
                <div type= "submit" style= {{display: this.state.edit ? "none" : "", width:"5vw", height:"4vh", marginLeft:  "20vw"  ,backgroundColor:"#3A7F95", marginTop:"1vh", marginRight:"2vw"}}
                 ...
                 onClick={this.updateUser(this.state.user.id)}> 
                  ...
                  <div  type= "submit" style= {{width:"5vw", height:"4vh", backgroundColor:"#3A7F95", marginTop:"1vh", 
                  display: this.state.edit ? "inline-block" : 'none' }} onClick={this.handleEdit}> 
                    Cancel
                  </div>
